...
namespace ClinicHealthcareSystem.Views
{
    ...
    /// </summary>
    public sealed partial class AdminTransitionPage : Page
    {
        public AdminTransitionPage()
        {
        ...
        {
            this.Frame.Navigate(typeof(QueryPage), null, new EntranceNavigationTransitionInfo());
        }
    }
}
